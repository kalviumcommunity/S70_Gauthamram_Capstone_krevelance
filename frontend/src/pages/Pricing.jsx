...
const GlassCard = ({ className, children, ...props }) => {
  return (
    <div
      className={`bg-[#1C1919] backdrop-blur-md rounded-xl w-100 shadow-lg border border-white/10 ${className}`}
      {...props}
    >
      {children}
    </div>
    ...
    <div>
      <GlassCard
        className={` overflow-hidden transition-all duration-300 ${
          isPopular
            ? "border-[#0FCE7C] scale-105 z-10 shadow-xl"
            : "border-white"
        } ${className}`}
      >
        {isPopular && (
            ...
            {features.map((feature, index) => {
              return (
                <div key={index} className="flex items-start">
                  ...
                  >
                    {feature.included && (
                      <CheckIcon className="h-3 w-3 rounded-full " />
                    )}
                  </div>
                  <span
                    className={
  ...
  return (
    <div className="min-h-screen bg-black text-white text-center">
      <div className="container mx-auto px-4 py-12 justify-center items-center">
        ...
        <div className="flex items-center justify-center mb-12">
          <span
            className={`mr-3 text-sm ${
              !isAnnual
                ? "text-[#0FCE7C] justify-center font-medium"
                : "text-white"
            }`}
          >
            Monthly
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left justify-items-center min-h-screen">
        ...
        <div className=" text-left -mt-50">
          <GlassCard className=" mx-auto p-10 w-full max-w-5xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400">
                  ...
                  you upgrade, the new pricing will be applied immediately. If
                  you downgrade, the new pricing will be applied on your next
                  billing cycle.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-400">
                  We accept PayPal, and Razor pay for annual plans. Enterprise
                  plans can also be paid via invoice.
                </p>
              </div>
